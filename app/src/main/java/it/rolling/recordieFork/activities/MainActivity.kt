...
import it.rolling.recordieFork.adapters.VideoAdapter
import it.rolling.recordieFork.common.ScreenVideo
import it.rolling.recordieFork.common.SdkHelper
import it.rolling.recordieFork.interfaces.AdapterInterface
import it.rolling.recordieFork.services.ScreenRecorderService
import it.rolling.recordieFork.tasks.UpdateSingleVideoTask
import it.rolling.recordieFork.tasks.UpdateVideosTask
import it.rolling.recordieFork.utils.ThemeHelper
import it.rolling.recordieFork.utils.Utils
import it.rolling.recordieFork.views.VideoRecyclerView
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var bro : CoordinatorLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        MobileAds.initialize(this) {
            bro = findViewById(R.id.include)
            val param = bro.layoutParams as CoordinatorLayout.LayoutParams
            param.setMargins(0,AdSize.SMART_BANNER.getHeightInPixels(baseContext),0,0)
            bro.layoutParams = param
        ...
        mInterstitialAd.adUnitId = "ca-app-pub-4975056503352119/7162564133"
